...
import { Sparkles, Scissors, Layers, Clock, CheckCircle2 } from "lucide-react";
import { content } from "@/lib/content";

const c = content.treatments.scarTransplant;
const candidateIcons = [Scissors, Layers, Clock, CheckCircle2];

export default function ScarTransplant() {
    return (
        <div className="min-h-screen bg-[#020410] text-white selection:bg-accent selection:text-white">
            ...
            <section className="min-h-[80vh] flex items-center justify-center relative border-b border-white/5 overflow-hidden">
                <div className="absolute inset-0 z-0 opacity-40">
                    <Image src={c.hero.image} alt="Scar Camouflage" fill className="object-cover" priority />
